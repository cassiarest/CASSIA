...
function WhyChooseUs() {
	...
	const gridStyle = {
		display: "grid",
		gridTemplateColumns: isMobile ? "1fr" : "550px 1fr",
	...
	return (
		<div style={sectionStyle}>
			<div style={containerStyle}>
				...
				<div style={gridStyle}>
					{/* Image Card on left */}
					<div style={{ width: "100%", justifySelf: isMobile ? "stretch" : "start" }}>
						<motion.div
					...
					{/* Text Content - Single card on right */}
					<motion.div 
						variants={textReveal}
						custom={3}
						initial="hidden"
					...
					>
						<p style={{ margin: "0 0 20px 0", fontSize: isMobile ? "15px" : "22px" }}>
						...
						<p style={{ margin: "0", fontSize: isMobile ? "15px" : "22px" }}>
